...
static const struct fs_path_config android_files[] = {
    ...
    { 00755, AID_ROOT,      AID_ROOT,      0, "system/etc/utopia/need_wifi_default.sh" },
    { 00755, AID_ROOT,      AID_ROOT,      0, "system/etc/utopia/system_defaults" },
    { 00755, AID_ROOT,      AID_ROOT,      0, "system/etc/utopia/service.d/*" },
