...
case "$variant" in
	"2_3_2_1")
	/bin/sh /etc/init.kernel.post_boot-pineapple_default_2_3_2_1.sh
	;;
	"2_3_1_1")
	/bin/sh /etc/init.kernel.post_boot-pineapple_2_3_1_1.sh
	;;
	"2_2_2_0")
	/bin/sh /etc/init.kernel.post_boot-pineapple_2_2_2_0.sh
	;;
	"2_3_2_0")
	/bin/sh /etc/init.kernel.post_boot-pineapple_2_3_2_0.sh
	;;
	"1_2_2_1")
	/bin/sh /etc/init.kernel.post_boot-pineapple_1_2_2_1.sh
	;;
	"1_3_1_1")
	/bin/sh /etc/init.kernel.post_boot-pineapple_1_3_1_1.sh
	;;
	*)
