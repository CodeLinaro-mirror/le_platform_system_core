...
%define EXTRA_OECONF --with-glib --with-mkbootimg-includes=%{_builddir}/mkbootimg --with-systemd --enable-adb-root
...
%license NOTICE
/sbin/adbd
%dir %{_sysconfdir}/initscripts
%{_sysconfdir}/initscripts/adbd
%{_sysconfdir}/launch_adbd
%{_sysconfdir}/adb_devid
